...
export PGUSER=geodb
psql -h localhost locophoto -c "create table likes (id serial, photosetid int, userid int)";
psql -h localhost locophoto -c "create unique index likesphotosetuseridx on likes (photosetid, userid)"
